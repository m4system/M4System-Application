...
class HostChecksAdmin(VersionAdmin):
    fields = (
        'name', 'verbosename', 'hosts', 'checktype', 'interval', 'arg', 'unit', 'quotient', 'threshold', 'sla',
        'allhosts',
        'colorizesla', 'enabled', 'note',)
    list_display = (
        'name', 'verbosename', 'checktype', 'interval', 'arg', 'unit', 'quotient', 'allhosts', 'colorizesla',
        'enabled',)
    list_display_links = ('name', 'verbosename',)
    list_filter = (
        'hosts', 'checktype', 'interval', 'unit', 'quotient', 'threshold', 'sla', 'allhosts', 'colorizesla', 'enabled',)
    search_fields = ['name', 'verbosename', 'checktype', 'interval', 'arg', 'unit', 'quotient', 'allhosts',
                     'colorizesla', 'enabled', 'note', ]
...
class ThresholdsAdmin(VersionAdmin):
    fieldsets = (
        ...
        ('Alerting options', {
            'fields': (
                'critgroups', 'crittpl', 'critrepeat', 'okgroups', 'oktpl', 'warngroups', 'warntpl', 'warnrepeat',
                'errgroups', 'errtpl',)
        }),
        ('Fill *ONLY* one of the three sections below: INT / BOOL / STR', {
            'fields': (
                'lowwarn', 'lowcrit', 'highwarn', 'highcrit', 'boolgood', 'boolbad', 'boolwarn', 'strgood', 'strwarn',
                'strbad'),
        }),
    )

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo',
                 models.CharField(default='img/m4.png', help_text='Enter the path to your logo relative to /static/',
                                  max_length=256, verbose_name='Company Logo')),
                ('slogan', models.CharField(default='M is for Modern Monitoring and Management',
                                            help_text='Tag Line on the dashboard.', max_length=1024,
                                            verbose_name='Company Slogan')),
                ('template', models.CharField(default='default/default',
